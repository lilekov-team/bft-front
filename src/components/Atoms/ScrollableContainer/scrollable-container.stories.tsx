...
export default {
    title: 'Components/Atoms/ScrollableContainer',
...
const Template: ComponentStory<typeof ScrollableContainer> = (args) => {
    ...
    return <ScrollableContainer {...args} />
...
export const DefaultScrollableContainer = Template.bind({});
DefaultScrollableContainer.args = {
    width: "20rem",
    maxHeight: "20rem",
    thumbColor: '#111111',
