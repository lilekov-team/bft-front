    ...
    return (
        <div ref={ref} className="w-full flex flex-col mt-[12.5rem] px-[7.5rem] relative z-0">
            ...
            <div className="mt-[5.625rem] mb-[2rem]">
                <p className="mb-[1rem] text-white text-lg">
                    Тема: Сверхновые ценности БФТ.

                </p>
                <p className="mb-[1rem] text-white text-lg">
                    Главный критерий успеха: диалоги в сценарии должны максимально ярко раскрывать<br /> главную тему.

                </p>
                <p className=" text-white text-lg">
                    Механика:  впишите вариант продолжения кино в форму ниже, либо загрузите свою версию<br /> сценария отдельным файлом. Лучшая работа будет озвучена голосами профессиональных<br /> актёров. И, конечно, по всем правилам киноиндустрии, лучший сценарист получит<br /> вознаграждение - БФТ-деньги.
                </p>
            </div>
