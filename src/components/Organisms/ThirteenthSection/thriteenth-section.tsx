    ...
    return (
        <div ref={ref} className="w-full flex flex-col mt-[12.5rem] px-[14.5rem] relative z-0">
            ...
            <p className="mb-[1rem] text-white text-lg">
                Про космос снято немало кинолент. Но ни одна из них не посвящена Сверхновым ценностям<br /> БФТ. Настало время это исправить. Мы запускаем конкурс на лучший сценарий.<br /> Как принять участие?
            </p>
            <p className="mb-[5.625rem] text-white text-lg">
                Посмотрите эпизод из кино. В нём озвучено только начало. Придумайте и напишите <br /> продолжение!
            </p>
            <Video
                color="pink"
            ...
            <div className="mt-[5.625rem] mb-[2rem]">
                ...
                <p className=" text-white text-lg">
                    ...
                    <br /> Затем загрузите файл и нажмите кнопку «отправить». <br /> Для творческого процесса вы можете объединяться в команды. <br /> Свой выбор жюри сделает 2 сентября. <br /> Лучшая работа будет озвучена голосами профессиональных актёров.<br /> И, конечно, по всем правилам киноиндустрии, за лучший сценарий <br /> полагается вознаграждение - БФТ-деньги. За второе и третье место – юбилейный мерч!
                </p>
            </div>
