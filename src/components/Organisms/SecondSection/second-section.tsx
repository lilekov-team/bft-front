...
const data: {
    ...
    7: {
        route: Routes.Works,
        text: `Пусконаладочные работы. Здесь как и в IT- проектах нужны точные расчёты. Предлагаем проверить<br/> наши интеллектуальные способности в космической онлайн-игре “Неизвестная переменная”. Для этого<br/> собираем команду, читаем инструкцию и помним, что успех рассчитывается по формуле БФТ=5<span class="sup">2</span>!<br/> Кстати, до Аукциона остаётся всё меньше и меньше световых лет, поэтому не упустите шанс<br/> заработать ещё больше БФТ-денег! И послушать подкаст под названием “Посыл во вселенную”.
        `
    },
    8: {
        route: Routes.Exit,
