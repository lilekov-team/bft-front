                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col mb-5rem">
                        <p className="text-white text-lg mb-[1rem]">
                            В каждом звездном экипаже есть люди, на которых стоит равняться. Каждый<br /> год мы отмечаем таких сотрудников в Команде БФТ. Они не просто работают,<br /> а привносят новые идеи,
                            развивают Компанию и вместе с ней стремятся<br /> каждый день быть лучше, чем вчера!
